// Constrained array scaling: 10,000 items with min/max constraints on every field
// Measures how constraint checking overhead scales with payload size

export const testDataObj = Array.from({ length: 10000 }, (_, i) => ({
  id: i,
  value: i % 10000,
  label: `Item ${i}`,
}))
