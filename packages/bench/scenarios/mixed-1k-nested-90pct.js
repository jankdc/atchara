// Real-world scenario: 1,000 items with complex nested schema, 90% valid / 10% invalid
// 90% of payloads parse successfully, 10% fail at distributed positions (early/mid/late)
...
if (import.meta.main) {
  ...
  await profileScenario(
    '1000-nested-user-objects-90-10-valid',
    async () => {
