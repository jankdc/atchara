// Constrained record scaling: 1,000 entries with min/max constraints on every value field
// Measures how constraint checking overhead scales with payload size

export const testDataObj = Object.fromEntries(
  Array.from({ length: 1000 }, (_, i) => [`key_${i}`, { score: i % 100, tag: `tag_${i}` }])
)
