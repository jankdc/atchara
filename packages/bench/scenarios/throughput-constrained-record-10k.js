// Constrained record scaling: 10,000 entries with min/max constraints on every value field
// Measures how constraint checking overhead scales with payload size

export const testDataObj = Object.fromEntries(
  Array.from({ length: 10000 }, (_, i) => [`key_${i}`, { score: i % 100, tag: `tag_${i}` }])
)
