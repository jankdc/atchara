// Constrained array scaling: 50,000 items with min/max constraints on every field
// Measures how constraint checking overhead scales with payload size

export const testDataObj = Array.from({ length: 50000 }, (_, i) => ({
  id: i,
  value: i % 10000,
  label: `Item ${i}`,
}))
